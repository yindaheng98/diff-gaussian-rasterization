...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        (point_list_unsorted, point_list, point_list_depth_unsorted, point_list_tileid_unsorted, point_list_depth, point_list_tileid) = _C.parse_binning_buffer(binningBuffer, num_rendered, raster_settings.debug)
